...
function setLanguage(language) {
  ...
  try {
    localStorage.setItem("intellectual-twin-insurance-arag-language", safeLanguage);
  } catch {
...
try {
  savedLanguage = localStorage.getItem("intellectual-twin-insurance-arag-language");
} catch {
